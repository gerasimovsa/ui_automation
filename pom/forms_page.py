...
class PracticeFormPage(BasePage):
    ...
    @allure.step("Filling and submitting for with generated data")
    def submit_filled_form(self):
        ...
        with allure.step("Getting generated data adn file"):
        ...
        self.remove_footer()
        with allure.step("Filling fields with text and selecting options"):
        ...
        with allure.step("Selecting data fro calendar"):
    ...
    @allure.step("Getting result table data")
